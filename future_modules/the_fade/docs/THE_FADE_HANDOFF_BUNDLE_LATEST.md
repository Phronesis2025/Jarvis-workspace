...
- **Tranche 24 pilot:** **Final slot executed and documented** (`t24_fr_pilot_06`); interim pilot is complete; **do not** claim pass/fail vs **0.8**.

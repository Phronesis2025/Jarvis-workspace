...
**Version:** 1.8  
**Last Updated:** 2026-03-25T19:45:01.2595380-05:00  
**Owner:** Jason  
...
| Reliability vs `required_reliability_threshold` (0.8) | **No honest comparison yet** — **`reliability`** dimension is **partial**; **Tranche 21** full pre-audit protocol (**48h** / **24** tries / **≥20** counted before **0.8**) remains the **stricter** documented standard; **Tranche 24** reclassifies ongoing work as an **availability-constrained interim pilot** (Federal Register only; **≤8** counted max if all pilot slots run); **2** already logged (**`t22_fr_000`**, **`t22_fr_001`**); pilot **does NOT** justify **0.8** — **go/no-go on continued testing** only |

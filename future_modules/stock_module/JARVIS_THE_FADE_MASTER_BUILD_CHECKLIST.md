...
**Version:** 1.7  
**Last Updated:** 2026-03-25T18:29:39.8337695-05:00  
**Owner:** Jason  
...
| Reliability vs `required_reliability_threshold` (0.8) | **No honest comparison yet** — **`reliability`** dimension is **partial**; **live** 48h Federal Register window **in progress**; **2** counted attempts (**2** successes / **0** failures): **`t22_fr_000`**, **`t22_fr_001`** (Tranche **23** — Prompt **#71**); **≥20** counted attempts required before any **0.8** claim |

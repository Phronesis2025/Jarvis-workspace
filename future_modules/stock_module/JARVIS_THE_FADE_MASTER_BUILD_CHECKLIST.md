...
**Version:** 1.6  
**Last Updated:** 2026-03-25T16:14:11.7508065-05:00  
**Owner:** Jason  
...
| Reliability vs `required_reliability_threshold` (0.8) | **No honest comparison yet** — **`reliability`** dimension is **partial**; **Tranche 22** kicked off the **live** 48h Federal Register API pre-audit window (`window_start_utc` **2026-03-25T21:13:55Z**); **only attempt 0** executed so far (**1** counted success / **0** failures); **≥20** counted attempts required before any **0.8** claim |

...
- Branch Name: `jarvis-task-wcs-029`

## Problem Summary
Fake test: add fire emoji to hero CTA button label.

## Goal
Resolve: Fake test: add fire emoji to hero CTA button label, with the smallest safe change that satisfies QA.

## Suspected Files
- src/components/Hero.tsx

## Acceptance Criteria
- The scoped issue is resolved: Fake test: add fire emoji to hero CTA button label

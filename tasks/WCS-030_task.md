...
- Branch Name: `jarvis-task-wcs-030`

## Problem Summary
Fake test: add temporary TEST MODE badge below hero headline.

## Goal
Resolve: Fake test: add temporary TEST MODE badge below hero headline, with the smallest safe change that satisfies QA.

## Suspected Files
- src/components/Hero.tsx

## Acceptance Criteria
- The scoped issue is resolved: Fake test: add temporary TEST MODE badge below hero headline

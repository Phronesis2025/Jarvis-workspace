...
- Branch Name: `jarvis-task-wcs-009`

## Problem Summary
Improve LogoMarquee response.ok handling and fallback.

## Goal
Resolve: Improve LogoMarquee response.ok handling and fallback, with the smallest safe change that satisfies QA.

## Suspected Files
- src/components/LogoMarquee.tsx

## Acceptance Criteria
- The scoped issue is resolved: Improve LogoMarquee response.ok handling and fallback
...
## System Impact
Medium risk. This should avoid unrelated production-facing behavior changes unless strictly necessary. Primary expected scope: src/components/LogoMarquee.tsx.

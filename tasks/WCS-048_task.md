...
- Branch Name: `jarvis-task-wcs-048`

## Problem Summary
Fake test: add calendar emoji to schedules page empty-state.

## Goal
Resolve: Fake test: add calendar emoji to schedules page empty-state, with the smallest safe change that satisfies QA.

## Suspected Files
- src/app/schedules/page.tsx

## Acceptance Criteria
- The scoped issue is resolved: Fake test: add calendar emoji to schedules page empty-state

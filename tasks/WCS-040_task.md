...
- Branch Name: `jarvis-task-wcs-040`

## Problem Summary
Style test: change home hero subheading letter spacing.

## Goal
Resolve: Style test: change home hero subheading letter spacing, with the smallest safe change that satisfies QA.

## Suspected Files
- src/components/Hero.tsx

## Acceptance Criteria
- The scoped issue is resolved: Style test: change home hero subheading letter spacing

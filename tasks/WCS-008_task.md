...
- Branch Name: `jarvis-task-wcs-008`

## Problem Summary
Clarify navbar Coaches link label for logged-out users.

## Goal
Resolve: Clarify navbar Coaches link label for logged-out users, with the smallest safe change that satisfies QA.

## Suspected Files
- src/components/Navbar.tsx

## Acceptance Criteria
- The scoped issue is resolved: Clarify navbar Coaches link label for logged-out users
...
## System Impact
Low risk. This should avoid unrelated production-facing behavior changes unless strictly necessary. Primary expected scope: src/components/Navbar.tsx.

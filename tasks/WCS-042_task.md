...
- Branch Name: `jarvis-task-wcs-042`

## Problem Summary
Fake test: add temporary TEST MODE badge on about page.

## Goal
Resolve: Fake test: add temporary TEST MODE badge on about page, with the smallest safe change that satisfies QA.

## Suspected Files
- src/app/about/page.tsx

## Acceptance Criteria
- The scoped issue is resolved: Fake test: add temporary TEST MODE badge on about page

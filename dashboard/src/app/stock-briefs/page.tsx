    ...
    <div className="space-y-6">
      ...
      <div className="hud-panel p-4">
        ...
        <form method="get" className="mt-3 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          ...
          <button
            type="submit"
            className="rounded-lg border border-primary/20 bg-primary/15 px-3 py-2 text-sm font-medium text-primary hover:bg-primary/20"
          >
            Show
          </button>
        </form>
      ...
      <p className="text-xs text-muted-foreground">
        <span className="font-medium text-foreground">Risk gate terms:</span>{" "}
        <strong className="text-foreground">Pass</strong> — no major issues were
        raised in this review. <strong className="text-foreground">Caution</strong>{" "}
        — some concerns were raised and should be checked by a person.{" "}
        <strong className="text-foreground">Flag</strong> — a stronger warning was
